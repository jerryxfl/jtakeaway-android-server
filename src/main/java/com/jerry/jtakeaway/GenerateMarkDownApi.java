...
//设定端口，申明启动类！！重要
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT, classes = JtakeawayApplication.class)
public class GenerateMarkDownApi {
    ...
    public void generateAsciiDocs() throws Exception {
        ...
        Swagger2MarkupConverter.from(new URL("http://localhost:8080/api-0.1/v2/api-docs"))
                .withConfig(config)
                .build()
